# product_module/admin.py - Simplified Version
...
class ProductCategoryAdmin(admin.ModelAdmin):
    list_display = ['title', 'url_title', 'parent', 'is_active', 'created_at']
    list_filter = ['is_active', 'is_delete', 'created_at', 'parent']
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['title', 'price', 'size', 'color', 'stock_quantity', 'is_featured', 'is_active', 'created_at']
    list_filter = ['is_active', 'is_delete', 'is_featured', 'size', 'color', 'category', 'created_at']
...
class ProductGalleryAdmin(admin.ModelAdmin):
    list_display = ['id', 'image_preview', 'alt_text', 'is_active', 'created_at']
...
class ProductDiscountAdmin(admin.ModelAdmin):
    list_display = ['title', 'product', 'discount_type', 'value', 'start_date', 'end_date', 'is_active']
    list_filter = ['discount_type', 'is_active', 'start_date', 'end_date']
    search_fields = ['title', 'product__title']
    list_editable = ['is_active']
    date_hierarchy = 'start_date'
    
    fields = ['product', 'title', 'discount_type', 'value', 'start_date', 'end_date', 'is_active']
...
class OrderItemAdmin(admin.ModelAdmin):
    ...
    search_fields = ['order__order_id', 'product_title']
