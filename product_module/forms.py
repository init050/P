...
class AddToCartForm(forms.ModelForm):
    ...
    def clean_quantity(self):
        ...
        if self.product and quantity > self.product.stock_quantity:
            raise ValidationError(_('Not enough stock available. Only {} items left.').format(self.product.stock_quantity))
        return quantity
...
class CheckoutForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
                Submit('submit', _('Place Order'), css_class='bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg'),
...
class ProductDiscountForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['title', 'discount_type', 'value', 'start_date', 'end_date']
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
                Submit('submit', _('Create Discount'), css_class='bg-blue-600 hover:bg-blue-700'),
